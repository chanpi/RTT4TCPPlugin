========================================================================
    Win32 アプリケーション: RTT4TCPPlugin プロジェクトの概要
========================================================================

この RTT4TCPPlugin アプリケーションは、AppWizard により作成されました。

このファイルには、RTT4TCPPlugin 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


RTT4TCPPlugin.vcxproj
...
RTT4TCPPlugin.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル RTT4TCPPlugin.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル RTT4TCPPlugin.rc 
    にインクルードされます。
